...
See the [Node.js Release Schedule](https://nodejs.org/en/about/releases/) for the official EOL schedule.
...
1. Go to the [Security tab](https://github.com/jsonlt/jsonlt-javascript/security) of the repository
